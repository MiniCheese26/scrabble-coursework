...
import {GameGridElement, GameStateGridItem, SurroundingIndexes} from "../types/gamestate";
...
export class GameStateHelpers {
  ...
  static isEmpty(gridItem: GameStateGridItem) {
    if (gridItem.empty) {
      return gridItem;
    }
  ...
  static isNotEmpty(gridItem: GameStateGridItem) {
